...
func _check_layout(failures: PackedStringArray) -> void:
	var required := PackedStringArray([
		...
		"res://tools/glb_kit.py",
		"res://third_party/polyhaven/ATTRIBUTION.md",
		"res://third_party/polyhaven/textures/pine_bark/pine_bark_diff_1k.jpg",
		"res://third_party/polyhaven/models/wooden_crate_01/wooden_crate_01_1k.gltf",
